...
int main(){
    ...
    //variáveis temporárias para cálculo de densidade e renda
    int densidade;
    float renda;
    ...
    densidade=calcularDensidade(A_1_POP,A_1_KM);
    renda=calcularRenda(A_1_PIB,A_1_POP);
    printf("\nDensidade Populacional: %d pessoas/km²",densidade);
    ...
    //Calcular densidade demográfica e renda per capita
    densidade=calcularDensidade(A_2_POP,A_2_KM);
    renda=calcularRenda(A_2_PIB,A_2_POP);
    printf("\nDensidade Populacional: %d pessoas/km²",densidade);
    printf("\nPIB per Capita: R$ %.2f /ano\n\n",renda);
    printf("-----------------------------------------------------------\nProxima carta:\n");
    ...
    //Calcular densidade demográfica e renda per capita
    densidade=calcularDensidade(A_3_POP,A_3_KM);
    renda=calcularRenda(A_3_PIB,A_3_POP);
    printf("\nDensidade Populacional: %d pessoas/km²",densidade);
    printf("\nPIB per Capita: R$ %.2f /ano\n\n",renda);
    printf("-----------------------------------------------------------\nProxima carta:\n");
    ...
    //Calcular densidade demográfica e renda per capita
    densidade=calcularDensidade(A_4_POP,A_4_KM);
    renda=calcularRenda(A_4_PIB,A_4_POP);
    printf("\nDensidade Populacional: %d pessoas/km²",densidade);
    printf("\nPIB per Capita: R$ %.2f /ano\n\n",renda);
    printf("-----------------------------------------------------------\nProxima carta:\n");
    ...
    //Calcular densidade demográfica e renda per capita
    densidade=calcularDensidade(B_1_POP,B_1_KM);
    renda=calcularRenda(B_1_PIB,B_1_POP);
    printf("\nDensidade Populacional: %d pessoas/km²",densidade);
    printf("\nPIB per Capita: R$ %.2f /ano\n\n",renda);
    printf("-----------------------------------------------------------\nProxima carta:\n");
    ...
    //Calcular densidade demográfica e renda per capita
    densidade=calcularDensidade(B_2_POP,B_2_KM);
    renda=calcularRenda(B_2_PIB,B_2_POP);
    printf("\nDensidade Populacional: %d pessoas/km²",densidade);
    printf("\nPIB per Capita: R$ %.2f /ano\n\n",renda);
    printf("-----------------------------------------------------------\nProxima carta:\n");
    ...
    //Calcular densidade demográfica e renda per capita
    densidade=calcularDensidade(B_3_POP,B_3_KM);
    renda=calcularRenda(B_3_PIB,B_3_POP);
    printf("\nDensidade Populacional: %d pessoas/km²",densidade);
    printf("\nPIB per Capita: R$ %.2f /ano\n\n",renda);
    printf("-----------------------------------------------------------\nProxima carta:\n");
    ...
    //Calcular densidade demográfica e renda per capita
    densidade=calcularDensidade(B_4_POP,B_4_KM);
    renda=calcularRenda(B_4_PIB,B_4_POP);
    printf("\nDensidade Populacional: %d pessoas/km²",densidade);
    printf("\nPIB per Capita: R$ %.2f /ano\n\n",renda);
    printf("-----------------------------------------------------------\nProxima carta:\n");
    ...
    //Calcular densidade demográfica e renda per capita
    densidade=calcularDensidade(C_1_POP,C_1_KM);
    renda=calcularRenda(C_1_PIB,C_1_POP);
    printf("\nDensidade Populacional: %d pessoas/km²",densidade);
    printf("\nPIB per Capita: R$ %.2f /ano\n\n",renda);
    printf("-----------------------------------------------------------\nProxima carta:\n");
    ...
    //Calcular densidade demográfica e renda per capita
    densidade=calcularDensidade(C_2_POP,C_2_KM);
    renda=calcularRenda(C_2_PIB,C_2_POP);
    printf("\nDensidade Populacional: %d pessoas/km²",densidade);
    printf("\nPIB per Capita: R$ %.2f /ano\n\n",renda);
    printf("-----------------------------------------------------------\nProxima carta:\n");
    ...
    //Calcular densidade demográfica e renda per capita
    densidade=calcularDensidade(C_3_POP,C_3_KM);
    renda=calcularRenda(C_3_PIB,C_3_POP);
    printf("\nDensidade Populacional: %d pessoas/km²",densidade);
    printf("\nPIB per Capita: R$ %.2f /ano\n\n",renda);
    printf("-----------------------------------------------------------\nProxima carta:\n");
    ...
    //Calcular densidade demográfica e renda per capita
    densidade=calcularDensidade(D_1_POP,D_1_KM);
    renda=calcularRenda(D_1_PIB,D_1_POP);
    printf("\nDensidade Populacional: %d pessoas/km²",densidade);
    printf("\nPIB per Capita: R$ %.2f /ano\n\n",renda);
    printf("-----------------------------------------------------------\nProxima carta:\n");
    ...
    //Calcular densidade demográfica e renda per capita
    densidade=calcularDensidade(D_2_POP,D_2_KM);
    renda=calcularRenda(D_2_PIB,D_2_POP);
    printf("\nDensidade Populacional: %d pessoas/km²",densidade);
    printf("\nPIB per Capita: R$ %.2f /ano\n\n",renda);
    printf("-----------------------------------------------------------\nProxima carta:\n");
    ...
    //Calcular densidade demográfica e renda per capita
    densidade=calcularDensidade(D_3_POP,D_3_KM);
    renda=calcularRenda(D_3_PIB,D_3_POP);
    printf("\nDensidade Populacional: %d pessoas/km²",densidade);
    printf("\nPIB per Capita: R$ %.2f /ano\n\n",renda);
    printf("-----------------------------------------------------------\nProxima carta:\n");
    ...
    //Calcular densidade demográfica e renda per capita
    densidade=calcularDensidade(D_4_POP,D_4_KM);
    renda=calcularRenda(D_4_PIB,D_4_POP);
    printf("\nDensidade Populacional: %d pessoas/km²",densidade);
    printf("\nPIB per Capita: R$ %.2f /ano\n\n",renda);
    printf("-----------------------------------------------------------\nProxima carta:\n");
    ...
    //Calcular densidade demográfica e renda per capita
    densidade=calcularDensidade(E_1_POP,E_1_KM);
    renda=calcularRenda(E_1_PIB,E_1_POP);
    printf("\nDensidade Populacional: %d pessoas/km²",densidade);
    printf("\nPIB per Capita: R$ %.2f /ano\n\n",renda);
    printf("-----------------------------------------------------------\nProxima carta:\n");
    ...
    //Calcular densidade demográfica e renda per capita
    densidade=calcularDensidade(E_2_POP,E_2_KM);
    renda=calcularRenda(E_2_PIB,E_2_POP);
    printf("\nDensidade Populacional: %d pessoas/km²",densidade);
    printf("\nPIB per Capita: R$ %.2f /ano\n\n",renda);
    printf("-----------------------------------------------------------\nProxima carta:\n");
    ...
    //Calcular densidade demográfica e renda per capita
    densidade=calcularDensidade(E_3_POP,E_3_KM);
    renda=calcularRenda(E_3_PIB,E_3_POP);
    printf("\nDensidade Populacional: %d pessoas/km²",densidade);
    printf("\nPIB per Capita: R$ %.2f /ano\n\n",renda);
    printf("-----------------------------------------------------------\nProxima carta:\n");
    ...
    //Calcular densidade demográfica e renda per capita
    densidade=calcularDensidade(E_4_POP,E_4_KM);
    renda=calcularRenda(E_4_PIB,E_4_POP);
    printf("\nDensidade Populacional: %d pessoas/km²",densidade);
    printf("\nPIB per Capita: R$ %.2f /ano\n\n",renda);
    printf("-----------------------------------------------------------\nProxima carta:\n");
    ...
    //Calcular densidade demográfica e renda per capita
    densidade=calcularDensidade(F_1_POP,F_1_KM);
    renda=calcularRenda(F_1_PIB,F_1_POP);
    printf("\nDensidade Populacional: %d pessoas/km²",densidade);
    printf("\nPIB per Capita: R$ %.2f /ano\n\n",renda);
    printf("-----------------------------------------------------------\nProxima carta:\n");
    ...
    //Calcular densidade demográfica e renda per capita
    densidade=calcularDensidade(F_2_POP,F_2_KM);
    renda=calcularRenda(F_2_PIB,F_2_POP);
    printf("\nDensidade Populacional: %d pessoas/km²",densidade);
    printf("\nPIB per Capita: R$ %.2f /ano\n\n",renda);
    printf("-----------------------------------------------------------\nProxima carta:\n");
    ...
    //Calcular densidade demográfica e renda per capita
    densidade=calcularDensidade(F_3_POP,F_3_KM);
    renda=calcularRenda(F_3_PIB,F_3_POP);
    printf("\nDensidade Populacional: %d pessoas/km²",densidade);
    printf("\nPIB per Capita: R$ %.2f /ano\n\n",renda);
    printf("-----------------------------------------------------------\nProxima carta:\n");
    ...
    //Calcular densidade demográfica e renda per capita
    densidade=calcularDensidade(F_4_POP,F_4_KM);
    renda=calcularRenda(F_4_PIB,F_4_POP);
    printf("\nDensidade Populacional: %d pessoas/km²",densidade);
    printf("\nPIB per Capita: R$ %.2f /ano\n\n",renda);
    printf("-----------------------------------------------------------\nProxima carta:\n");
    ...
    //Calcular densidade demográfica e renda per capita
    densidade=calcularDensidade(G_1_POP,G_1_KM);
    renda=calcularRenda(G_1_PIB,G_1_POP);
    printf("\nDensidade Populacional: %d pessoas/km²",densidade);
    printf("\nPIB per Capita: R$ %.2f /ano\n\n",renda);
    printf("-----------------------------------------------------------\nProxima carta:\n");
    ...
    //Calcular densidade demográfica e renda per capita
    densidade=calcularDensidade(G_2_POP,G_2_KM);
    renda=calcularRenda(G_2_PIB,G_2_POP);
    printf("\nDensidade Populacional: %d pessoas/km²",densidade);
    printf("\nPIB per Capita: R$ %.2f /ano\n\n",renda);
    printf("-----------------------------------------------------------\nProxima carta:\n");
    ...
    //Calcular densidade demográfica e renda per capita
    densidade=calcularDensidade(G_3_POP,G_3_KM);
    renda=calcularRenda(G_3_PIB,G_3_POP);
    printf("\nDensidade Populacional: %d pessoas/km²",densidade);
    printf("\nPIB per Capita: R$ %.2f /ano\n\n",renda);
    printf("-----------------------------------------------------------\nProxima carta:\n");
    ...
    //Calcular densidade demográfica e renda per capita
    densidade=calcularDensidade(G_4_POP,G_4_KM);
    renda=calcularRenda(G_4_PIB,G_4_POP);
    printf("\nDensidade Populacional: %d pessoas/km²",densidade);
    printf("\nPIB per Capita: R$ %.2f /ano\n\n",renda);
    printf("-----------------------------------------------------------\nProxima carta:\n");
    ...
    //Calcular densidade demográfica e renda per capita
    densidade=calcularDensidade(H_1_POP,H_1_KM);
    renda=calcularRenda(H_1_PIB,H_1_POP);
    printf("\nDensidade Populacional: %d pessoas/km²",densidade);
    printf("\nPIB per Capita: R$ %.2f /ano\n\n",renda);
    printf("-----------------------------------------------------------\nProxima carta:\n");
    ...
    //Calcular densidade demográfica e renda per capita
    densidade=calcularDensidade(H_2_POP,H_2_KM);
    renda=calcularRenda(H_2_PIB,H_2_POP);
    printf("\nDensidade Populacional: %d pessoas/km²",densidade);
    printf("\nPIB per Capita: R$ %.2f /ano\n\n",renda);
    printf("-----------------------------------------------------------\nProxima carta:\n");
    ...
    //Calcular densidade demográfica e renda per capita
    densidade=calcularDensidade(H_3_POP,H_3_KM);
    renda=calcularRenda(H_3_PIB,H_3_POP);
    printf("\nDensidade Populacional: %d pessoas/km²",densidade);
    printf("\nPIB per Capita: R$ %.2f /ano\n\n",renda);
    printf("-----------------------------------------------------------\nProxima carta:\n");
    ...
    //Calcular densidade demográfica e renda per capita
    densidade=calcularDensidade(H_4_POP,H_4_KM);
    renda=calcularRenda(H_4_PIB,H_4_POP);
    printf("\nDensidade Populacional: %d pessoas/km²",densidade);
    printf("\nPIB per Capita: R$ %.2f /ano\n\n",renda);
    printf("-----------------------------------------------------------\nProxima carta:\n");
